...
pub static GENERATED_PROJECTION_SPECS: &[GeneratedProjectionSpec] = &[
    ...
    GeneratedProjectionSpec {
        name: ProjectionName::NotesAuthoringState,
        depends_on: &["Note"],
    ...
    GeneratedProjectionSpec {
        name: ProjectionName::BoardsAuthoringState,
        depends_on: &["Board"],
        materialization: GeneratedMaterializationPlan::ReplaceOrRemove {
            snapshot_mode: GeneratedSnapshotMode::Field("state"),
            snapshot_omit_fields: &[],
    ...
    GeneratedProjectionSpec {
        name: ProjectionName::TasksBoard,
    ...
    GeneratedProjectionSpec {
        name: ProjectionName::WorkspaceCurrent,
        depends_on: &["Workspace"],
        materialization: GeneratedMaterializationPlan::Reset,
    },
    GeneratedProjectionSpec {
        name: ProjectionName::ActivityStreams,
        depends_on: &["Activity"],
    ...
    GeneratedProjectionSpec {
        name: ProjectionName::ActivityHistory,
        depends_on: &["Activity"],
        materialization: GeneratedMaterializationPlan::Replace {
            snapshot_mode: GeneratedSnapshotMode::Patch,
            snapshot_omit_fields: &[],
    ...
    GeneratedProjectionSpec {
        name: ProjectionName::SyncHealth,
...
pub static GENERATED_MUTATION_SPECS: &[GeneratedMutationSpec] = &[
    GeneratedMutationSpec {
        name: MutationName::NoteCreate,
        touches: &["Note"],
    },
    GeneratedMutationSpec {
        name: MutationName::NoteImportLoroUpdate,
        touches: &["Note"],
    },
    GeneratedMutationSpec {
        name: MutationName::NoteRename,
        touches: &["Note"],
    },
    GeneratedMutationSpec {
        name: MutationName::NoteDelete,
        touches: &["Note"],
    },
    GeneratedMutationSpec {
        name: MutationName::NotePin,
        touches: &["Note"],
    },
    GeneratedMutationSpec {
        name: MutationName::NoteMoveToBoard,
        touches: &["Note", "Board"],
    },
    GeneratedMutationSpec {
        name: MutationName::BoardCreate,
        touches: &["Board"],
    },
    GeneratedMutationSpec {
        name: MutationName::BoardImportLoroUpdate,
        touches: &["Board"],
    },
    GeneratedMutationSpec {
        name: MutationName::BoardReconcileArchivedColumnOrder,
        touches: &["Board"],
    },
    GeneratedMutationSpec {
        name: MutationName::TaskSave,
        touches: &["Task"],
    },
    GeneratedMutationSpec {
        name: MutationName::TaskSchedule,
        touches: &["Task"],
    },
    GeneratedMutationSpec {
        name: MutationName::TaskArchive,
        touches: &["Task"],
    },
    GeneratedMutationSpec {
        name: MutationName::WorkspaceConfigure,
        touches: &["Workspace"],
    },
    GeneratedMutationSpec {
        name: MutationName::SyncReset,
        touches: &["SyncHealth"],
    },
];
...
pub static GENERATED_ENTITY_AUTHORING_SPECS: &[GeneratedEntityAuthoringSpec] = &[
    GeneratedEntityAuthoringSpec {
        ...
        mutations: &[
            MutationName::NoteCreate,
            MutationName::NoteImportLoroUpdate,
            MutationName::NoteRename,
            MutationName::NoteDelete,
            MutationName::NotePin,
            MutationName::NoteMoveToBoard,
        ],
        content_mutation: Some(MutationName::NoteImportLoroUpdate),
        planning_mutations: &[],
        command_mutations: &[MutationName::NotePin, MutationName::NoteMoveToBoard],
        lifecycle_mutations: &[
            MutationName::NoteCreate,
            MutationName::NoteRename,
            MutationName::NoteDelete,
    ...
    GeneratedEntityAuthoringSpec {
        ...
        mutations: &[
            MutationName::NoteMoveToBoard,
            MutationName::BoardCreate,
            MutationName::BoardImportLoroUpdate,
            MutationName::BoardReconcileArchivedColumnOrder,
        ],
        content_mutation: Some(MutationName::BoardImportLoroUpdate),
        planning_mutations: &[
            MutationName::BoardReconcileArchivedColumnOrder,
            MutationName::NoteMoveToBoard,
        ],
        command_mutations: &[],
        lifecycle_mutations: &[MutationName::BoardCreate],
        session_mnemonic_key: Some("notebook.session.drafts"),
        conflict_policy: Some(GeneratedAuthoringConflictPolicy::GeneratedFieldPolicy),
    },
    GeneratedEntityAuthoringSpec {
        ...
        mutations: &[
            MutationName::TaskSave,
            MutationName::TaskSchedule,
            MutationName::TaskArchive,
        ],
        content_mutation: Some(MutationName::TaskSave),
        planning_mutations: &[MutationName::TaskSchedule],
        command_mutations: &[],
        lifecycle_mutations: &[MutationName::TaskArchive],
        session_mnemonic_key: Some("notebook.session.drafts"),
    ...
    GeneratedEntityAuthoringSpec {
        ...
        mutations: &[MutationName::WorkspaceConfigure],
        content_mutation: None,
        planning_mutations: &[],
        command_mutations: &[MutationName::WorkspaceConfigure],
        lifecycle_mutations: &[],
    ...
    GeneratedEntityAuthoringSpec {
        ...
        mutations: &[MutationName::SyncReset],
        content_mutation: None,
        planning_mutations: &[],
        command_mutations: &[MutationName::SyncReset],
        lifecycle_mutations: &[],
        session_mnemonic_key: None,
        conflict_policy: None,
    },
...
pub static NOTE_COLLABORATION_SPEC: GeneratedCollaborationEntitySpec =
    GeneratedCollaborationEntitySpec {
        ...
        authoring_projection: ProjectionName::NotesAuthoringState,
        import_mutation: MutationName::NoteImportLoroUpdate,
        root_container: "note",
...
pub static BOARD_COLLABORATION_SPEC: GeneratedCollaborationEntitySpec =
    GeneratedCollaborationEntitySpec {
        ...
        authoring_projection: ProjectionName::BoardsAuthoringState,
        import_mutation: MutationName::BoardImportLoroUpdate,
